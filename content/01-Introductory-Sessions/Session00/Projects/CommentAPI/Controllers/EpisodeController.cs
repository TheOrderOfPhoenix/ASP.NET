...
namespace C01_CommentAPI.Controllers
{
    ...
    public class EpisodeController : ControllerBase
    {
        ...
        public EpisodeController()
        {
            ...
            Episodes.Add(new Episode(0, "Welcome to Tech Insights Podcast!", description1, "2 hr 27 min", "episode-zero.jpg", new DateTime(2024, 10, 1)));
            Episodes.Add(new Episode(1, "Machine Learning 101", description2, "2 hr 3 min", "episode-one.jpg", new DateTime(2024, 10, 8)));
            Episodes.Add(new Episode(2, "Deep Learning Demystified", description3, "1 hr 13 min", "episode-two.jpg", new DateTime(2024, 11, 1)));
            Episodes.Add(new Episode(3, "AI", description4, "1 hr 10 min", "episode-three.png", new DateTime(2024, 11, 8)));
        }
        ...
        {
            return Episodes.FirstOrDefault(x=>x.Id == id);
        }

        [HttpPost]
        public object PostEpisode(Episode episode)
        {
            //Add to database


            return Ok("Sucessfully added the ");
        }

        [HttpPut]
        public object PutEpisode(Episode episode)
        {
            //
            return NotFound();
            return BadRequest();
        ...
        [HttpDelete]
        public List<Episode> DeleteEpisodes()
        {
            return Episodes.ToList();
        }
    }
